...
== Screenshots ==
1. **How to Add a Post Story Block:** Search in Block Post Story and You Will Find the Right Block as Screenshot shows
2. **Block Settings:** Customize the number of posts, font styles, spacing, and more in the block editor.
3. **Carousel Display:** Example of how the post stories carousel looks on the front end.
4. **Responsive Design:** Story carousel displayed on mobile devices.
